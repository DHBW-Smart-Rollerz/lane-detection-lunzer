...
def main() -> None:
    ...
    for tag, metrics in metric_sets.items():
        ...
        for m in existing:
            ...
            plot_metric_stats_by_degree(
                lane_stats, out_dir / f"fig_{m}_stats_vs_degree.pdf", metric=m
            )
