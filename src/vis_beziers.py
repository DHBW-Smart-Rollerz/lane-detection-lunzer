...
def main():
    ...
    p.add_argument(
        ...
        type=str,
        default=None,
        help="Render one specific image across all control-point counts. Accepts full image_path or just the basename.",
    )
...
if __name__ == "__main__":
    ...
    #
    # BESTIMMTES BILD MIT PFAD
    # python /workspace/src/vis_beziers.py --results /workspace/artifacts/results_bezier_densified_step10p0px.csv --specific-image /workspace/data/2023-05/img/2023-05-24-17-54-35/2023-05-24-17-54-35_frame000245.png --ctrl-list 4 6 8
